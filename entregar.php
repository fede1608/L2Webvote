...
<style type="text/css">
<!--
.Estilo1 {color: #4f4f4f}
-->
</style></head>
    <body>
    <table width="250" border="0" align="center" class="table_round"><center>
      <tr>
        <td class="none">
        <p>
        <strong><span class="Estilo1">Muchas gr&aacute;cias por tu voto </span></strong>
        <div class="noerrorh1"><span class="left">Ya casi terminas  <b><?php echo $_SESSION['login']; ?></b></span></div>
          <p><div class="cleaner_with_lowheight"></div>
          <div id="info"></div>
    ...
    <label>
      <select name="char_Id" id="char_Id">
        <?php
										...
										{
									?>
        <option value="<?php echo $c_a['charId'];?>"><?php echo $c_a['char_name'];?></option>
        <?php
										}
									?>
      </select>
