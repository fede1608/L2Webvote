...
//]]>
    ...
    <body>
        <div class="noerrorh1">
            <span class="left">Bienvenido! Os habeis conectado con la cuenta: <b>"<?php echo $_SESSION['login']; ?>"</b></span>
        ...
        <div class="noerrorh">
          <div id="info">
            ...
            <p align="left">
				<b>1.-</b> Antes de comenzar a votar, asegurese de tener tanto su personaje como la cuenta utilizada en este panel desconectada.<br>
				<br>
				<b>2.-</b> Vote en cada uno de los banners pinchando en su imagen. Os redireccionaran hacia su web en donde tendreis que votar y cuando voteis en uno, se desbloqueara el siguiente vote. Algunos requieren un codigo para evitar posibles bots y otros no. Por cada cinco votaciones realizadas con exito, obtendreis una medalla!<br>
				<br>
				<b>3.-</b> Una vez que hayais votado en todos los enlaces disponibles, pulsar sobre el enlace de "<b>Confirmar Votaciones</b>" y os aparecera una ventana en donde tendreis que indicarnos el personaje al que se le entregara la medalla. Os recordamos de nuevo que dicho personaje ha de estar desconectado, asi como su cuenta.<br>
				<br>
				<b>4.-</b> Una vez indicado el personaje, pulsamos sobre el boton de "<b>Recibir Recompensa</b>" y listo!<br>
				<br>
